...
const mpc = ffi.Library(
  path.join(__dirname, '..', '..', '..', 'crypto-mpc-js', 'deps', 'MPCCrypto'),
  {
    ...
    MPCCrypto_initRefreshKey: [
      ref.types.int,
      [ref.types.int, VoidPtr, VoidPtrPtr],
    ],

    // EdDSA specific functions
    // MPCCRYPTO_API int MPCCrypto_initGenerateEddsaKey(int peer, MPCCryptoContext ** context);
    MPCCrypto_initGenerateEddsaKey: [
      ref.types.int,
      [ref.types.int, VoidPtrPtr],
    ],
    ...
    MPCCrypto_verifyEddsa: [
      ref.types.int,
      [Uint8Ptr, ref.types.int, Uint8Ptr, ref.types.int, Uint8Ptr],
    ],
    ...
    MPCCrypto_initGenerateEcdsaKey: [
      ref.types.int,
      [ref.types.int, VoidPtrPtr],
    ],
    ...
    MPCCrypto_initGenerateGenericSecret: [
      ref.types.int,
      [ref.types.int, ref.types.int, VoidPtrPtr],
    ],

    // MPCCRYPTO_API int MPCCrypto_initImportGenericSecret(int peer, const uint8_t* key, int size, MPCCryptoContext ** context);
    MPCCrypto_initImportGenericSecret: [
      ref.types.int,
      [ref.types.int, Uint8Ptr, ref.types.int, VoidPtrPtr],
    ],
    ...
    MPCCrypto_initBackupEcdsaKey: [
      ref.types.int,
      [ref.types.int, VoidPtr, Uint8Ptr, ref.types.int, VoidPtrPtr],
    ],
    // MPCCRYPTO_API int MPCCrypto_getResultBackupEcdsaKey(MPCCryptoContext * context, uint8_t * out, int * out_size);
    MPCCrypto_getResultBackupEcdsaKey: [
      ref.types.int,
      [VoidPtr, Uint8Ptr, IntPtr],
    ],
    ...
    MPCCrypto_verifyEddsaBackupKey: [
      ref.types.int,
      [Uint8Ptr, ref.types.int, Uint8Ptr, Uint8Ptr, ref.types.int],
    ],
    ...
    MPCCrypto_restoreEddsaKey: [
      ref.types.int,
      [Uint8Ptr, ref.types.int, Uint8Ptr, Uint8Ptr, ref.types.int, Uint8Ptr],
    ],
    ...
    MPCCrypto_initDeriveBIP32: [
      ref.types.int,
      [ref.types.int, VoidPtr, ref.types.int, ref.types.uint, VoidPtrPtr],
    ],
