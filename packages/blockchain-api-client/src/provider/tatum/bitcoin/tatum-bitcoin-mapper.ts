...
import {
  ...
  TatumFees,
  TatumTransaction,
} from './tatum-bitcoin-types';

export const mapTatumBalance = (input: TatumBalance): BitcoinBalance => ({
  incoming: parseFloat(input.incoming),
  outgoing: parseFloat(input.outgoing),
});
...
export const mapTatumBroadcastTransaction = (
  broadcastTransaction: TatumBroadcastTransaction
